function DEL_res_k = computeDELResiduum_casadi_extKin(MBSys, simPars, ...
    ...
    % frames
    f_frame_k_b = computeBodyfixedFrameForces_sym(MBSys, g_k, f_frame_k_s_ext, simPars.g);
    ...
    for iFrm = 1:MBSys.nFrames
        ...
        f_frame_b_i = ...
            ...
            + h*f_frame_k_b{iFrm} ...
            + f.cayRTDInvSE3(eta_k{iFrm,1}*h, eta_k{iFrm,2}*h).' * MBSys.frameData.MGen{iFrm} * vertcat(eta_k{iFrm,:}) ...
            - f.cayRTDInvSE3(-eta_k0{iFrm,1}*h, -eta_k0{iFrm,2}*h).' * MBSys.frameData.MGen{iFrm} * vertcat(eta_k0{iFrm,:});
