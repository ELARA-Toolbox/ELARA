function links = systemDef_rigid_flexible_robot(opts)
    ...
    arguments
        ...
        opts.nSegments       (1,1) uint8  = 6;
    end

    % Rigid base links
    lR = [0.25,0.4,0.4];
    linksR = systemDef_rigid_robot("d", opts.dJoints, "l", lR);
    ...
    linkF.nSegments         = opts.nSegments;
    linkF.L            = 0.4;
    linkF.g_J_B        = eye(4);
