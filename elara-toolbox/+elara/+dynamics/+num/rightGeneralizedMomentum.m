function p_k = rightGeneralizedMomentum(system, h, simPars, q_k, q_k1, g_k1, eta_k, u_k1, a)
    ...
    J_k1 = system.computeGeomJacobianFast(q_k1, g_rel_k1);

    % Frame forces
    f_frame_k1_s = zeros(6, system.nFrames);    
    f_frame_k1_b = -h*a*elara.dynamics.num.bodyFixedFrameForces(g_k1, f_frame_k1_s, system, simPars);

    % Generalized Forces (stresses, actuation and dissipation)
    f_gen_k1 = ...
        - h*a*system.cSys .* (q_k1 - system.qRef) ...
        -   a*system.dSys .* (q_k1 - q_k) ...
        + h*a*system.computeInputMatrixFast(g_rel_k1) * u_k1;
