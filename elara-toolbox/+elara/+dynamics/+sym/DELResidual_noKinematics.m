function DEL_res_k = DELResidual_noKinematics(MBSys, simPars, ...
    ...
    for iFrm = 1:MBSys.nFrames
        ...
        f_frame_b_i = ...
            ...
            + h*f_frame_k_b{iFrm} ...
            + f.SE3.dcayInv(eta_k{iFrm,1}*h, eta_k{iFrm,2}*h).' * MBSys.frames.MGen{iFrm} * vertcat(eta_k{iFrm,:}) ...
            - f.SE3.dcayInv(-eta_k0{iFrm,1}*h, -eta_k0{iFrm,2}*h).' * MBSys.frames.MGen{iFrm} * vertcat(eta_k0{iFrm,:});
