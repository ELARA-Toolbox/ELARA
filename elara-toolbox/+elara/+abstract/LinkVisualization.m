classdef (Abstract) LinkVisualization < handle & matlab.mixin.Heterogeneous
    ...
    properties (SetAccess=protected)
        ...
        coordSysJ           (1,1) elara.visualization.CoordinateFrame

        % Coordinate system object for the TCP
        coordSysTCP         (1,1) elara.visualization.CoordinateFrame
    ...
    methods(Access=protected)
        function obj = drawTCPFrame(obj, parent)
            obj.coordSysTCP = elara.visualization.CoordinateFrame( obj.link.g_B_TCP, ...
                'scale', 0.07, ...
                'name', "TCP", ...
        ...
        function obj = drawJoint(obj, parent)
            ...
            % Draw joint frames
            coordSysScale = 0.075;
            obj.coordSysJ = elara.visualization.CoordinateFrame( ...
                inv(obj.link.g_J_B), ...
                "scale", coordSysScale, ...
