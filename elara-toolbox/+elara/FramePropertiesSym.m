classdef FramePropertiesSym < elara.abstract.FrameProperties
    %% FrameProperties Class (symbolic representation)
    ...
    properties
        ...
        % Relative SE(3) configurations of the tendon path frames (w.r.t.
